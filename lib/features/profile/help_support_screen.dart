                    ...
                    child: Column(
                      children: const [
                        ProfileMenuTile(
                          ...
                          subtitle: 'Learn how to sign up and start watching',
                        ),
                        ProfileMenuTile(
                          icon: Icons.credit_card_rounded,
                          title: 'Payment & Billing',
                          subtitle: 'Payment methods, failed payments and more',
                        ),
                        ProfileMenuTile(
                          icon: Icons.person_outline_rounded,
                          title: 'Account & Profile',
                          subtitle: 'Update your profile and account information',
                        ),
                        ProfileMenuTile(
                          icon: Icons.smart_display_outlined,
                          title: 'Watching & Playback',
                          subtitle: 'Stream, video quality and playback issues',
                        ),
                        ProfileMenuTile(
